...
* {
    ...
    .start {
    background: url(/display/bell/btn.png) no-repeat;
    background-position: center 0;
    }
    ...
    .slot {
    background: #fff url(/display/bell/bars.png)no-repeat;
    background-position: 0 4px;
    background-size: 100%;
    }

    .motion {
    background: #fff url(/display/bell/bars-blur.png);
    background-size: 100%;
    }
   
    #logo {

	background: url('/Bell/img/bell.jpg') no-repeat;
	height: 136px;
	width: 100%;
	...
	position: absolute;
	bottom: 0px;
	background: url('/Bell/img/bell-footer.jpg') no-repeat;
...
<div id="winner" style="display:none;"><b id="winloss">YOU WIN!</b><br/><br><br/><p id="booth"></p></div><div id="frame"></div><div id="tap"><!--<img src="/Bell/img/tap.png">--><br/><p>Tap Your Rystband to Play!</p></div><div id="wheels"><ul><li id="slot1" class="slot"></li><li id="slot2" class="slot"></li><li id="slot3" class="slot"></li></ul></div>
<div id="footer"></div>
   ...
   best += imgHeight ;
	...
	if (french==1) {
	 ...
	 $("#winloss").html("You WIN!");
       $("#booth").html("<small>Please collect your prize at the Samsung booth.</small>");
	}
    } 
    if ( winner == "prize" ) {
        bgPos = "0 -500px";
