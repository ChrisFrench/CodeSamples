...
* {
    ...
    .slot {
    background: #fff url(/display/bell/barsfr.png)no-repeat;
    background-position: 0 4px;
    background-size: 100%;
    }

    .motion {
    background: #fff url(/display/bell/barsfr-blur.png);
    background-size: 100%;
    }
...
<div id="winner" style="display:none;"><b id="winloss">YOU WIN!</b><br/><br><br/><p id="booth"></p></div><div id="frame"></div><div id="wheels"><ul><li id="slot1" class="slot"></li><li id="slot2" class="slot"></li><li id="slot3" class="slot"></li></ul></div>
<div id="footer"></div>
   ...
   best += imgHeight ;
	...
	if (french==1) {
	 ...
	 $("#booth").html("");
  	...
  	// english
	 $("#winloss").html("We're Sorry");
	 $("#booth").html("Please try again later.");
	}
