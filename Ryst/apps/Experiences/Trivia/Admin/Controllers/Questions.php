...
class Questions extends \Admin\Controllers\BaseAuth 
{
    use \Dsc\Traits\Controllers\AdminList;
    use \Dsc\Traits\Controllers\SupportPreview;
    use \Dsc\Traits\Controllers\EnablableItem;
    
    protected $list_route = '/admin/tilewall/tiles';

protected function getModel($name = 'questions')
    {
        $model = null;
        switch( $name ) {
        	case 'questions' :
	...
	public function index()
    {
        ...
        $this->app->set('meta.title', 'Questions');
        $this->app->set( 'allow_preview', $this->canPreview( true ) );
        
        $view = \Dsc\System::instance()->get('theme');
        echo $view->render('Experiences/Trivia/Admin/Views::questions/list.php');
    }
}