...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Questions <span> > List </span>
        </h1>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/trivia/question/create">Add New</a>
            </li>
        </ul>
    </div>
</div>
                ...
                <ul class="list-filters list-unstyled list-inline">
                    <li>
                        <select name="list[order]" class="form-control" onchange="this.form.submit();">
                            <option value="question" <?php if ($state->get('list.order') == 'question') { echo "selected='selected'"; } ?>>Question</option>
                        </select>
                    </li>
                    <li>
                    ...
                    <div class="input-group">
                        <select id="bulk-actions" name="bulk_action" class="form-control">
                            <option value="null">-Bulk Actions-</option>
                                <option value="delete" data-action="./admin/trivia/tiles/delete">Delete</option>
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11">
                            <div class="row">
                                ...
                                <?php if( !empty( $item->{'question_image.slug'} ) ) { ?>
                                    <a href="./admin/trivia/question/edit/<?php echo $item->id; ?>" title="<?php echo $item->question; ?>">
                                    <img class="img-responsive" src="./asset/thumb/<?php echo $item->{'question_image.slug'}; ?>" alt="<?php echo $item->question; ?>" />
                                    </a>
                                <?php } else { ?>
                                    &nbsp;
                                <?php } ?>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <legend><a href="./admin/trivia/question/edit/<?php echo $item->id; ?>"><?php echo $item->question; ?></a></legend>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <?php if( $allow_preview ) { ?>
                                    ...
                                    &nbsp;
                                <?php } ?>
                                    <a class="btn btn-xs btn-danger" data-bootbox="confirm" target="_blank" href="./admin/trivia/question/delete/<?php echo $item->id; ?>">
