            ...
            <div class="list-group-item">
                ...
                Dsc.refreshCategories = function(r) {
                    ...
                    var request = jQuery.ajax({
                        type: 'post', 
                        url: './admin/trivia/categories/checkboxes',
                        data: form_data
                    }).done(function(data){
                ...
                <div id="addCategoryForm" class="collapse">
                    <div class="panel-body">
                        ...
                        <div id="quick-form" action="./admin/trivia/category/create" data-callback="Dsc.refreshCategories" data-message_container="quick-form-response-container">
                        ...
                        <div id="parents" class="form-group">
                            <?php echo $this->renderLayout('Experiences/Trivia/Admin/Views::categories/list_parents.php'); ?>                    
                        </div>
                        <!-- /.form-group -->        
