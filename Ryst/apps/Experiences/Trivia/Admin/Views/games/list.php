...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Games <span> > List </span>
        </h1>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/trivia/game/create">Add New</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <div class="input-group">
                        <select id="bulk-actions" name="bulk_action" class="form-control">
                            <option value="null">-Bulk Actions-</option>
                                <option value="delete" data-action="./admin/trivia/games/delete">Delete</option>
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-11 col-sm-11 col-md-11">
                            <div class="row">
                                ...
                                <a href="/admin/trivia/game/luanchnow/<?php echo $item->id; ?>" class="btn btn-success">LAUNCH NOW</a>
                                <a href="/admin/trivia/game/turnoff/<?php echo $item->id; ?>" class="btn btn-danger">Game OFF</a>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <legend><a href="./admin/trivia/game/edit/<?php echo $item->id; ?>"><?php echo $item->title; ?></a></legend>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                            <div>
                                                <label>Slug:</label> <a target="_blank" href="./trivia/<?php echo $item->slug; ?>">/<?php echo $item->slug; ?> <i class="fa fa-external-link"></i></a>
                                            </div>
                                ...
                                <?php if( $allow_preview ) { ?>
                                    <a class="btn btn-xs btn-warning" target="_blank" href="./trivia/<?php echo $item->slug; ?>?preview=1">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    &nbsp;
                                <?php } ?>
                                    <a class="btn btn-xs btn-danger" data-bootbox="confirm" target="_blank" href="./admin/trivia/game/delete/<?php echo $item->id; ?>">
...
<script type="text/javascript">
    ...
    var pusher = new Pusher('da934d07d71e38c9225e');
    var channel = pusher.subscribe('adminTiles');
    channel.bind('newtile', function(data) {
     // alert(data.message);
         // alert(data.id);
         // alert(data.title);
        // alert(data.img);
