		...
		<legend>Select Your Role</legend>
            <?php foreach ($roles as $role) : ?>
                <div id="role" style="text-align:center;">
                    <a href="<?php echo $event->eventid; ?>/active/role/<?php echo $role['id'] ?>" class="button large inverse fg-white" style="width:80%; margin-bottom:25px;background:rgba(0,0,0,0.6)!important">
                        <?php echo $role['name']; ?>
                    </a>
