...
class User extends \Rystband\Site\Controllers\Users\Auth
{
    ...
    public function events()
    {
        ...
        $this->app->set('meta.title', 'My Events');
            
        $view = \Dsc\System::instance()->get('theme');
        echo $view->render( 'Users/Site/Views::events/list.php' );
    }
    ...
    public function settings()
    {
    	...
    	$this->app->set('meta.title', 'My Settings');
    
    	$view = \Dsc\System::instance()->get('theme');
    	echo $view->render( 'Users/Site/Views::settings/index.php' );
    }
