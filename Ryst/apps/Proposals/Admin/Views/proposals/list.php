<div class="row">
	...
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="./admin/proposal/create">Add New</a>
            </li>
        </ul>            	
	</div>
</div>

<form id="list-form" action="./admin/proposals" method="post">
    ...
    <div class="no-padding">
                ...
                <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3">
                    ...
                    <div class="input-group">
                        <select id="bulk-actions" name="bulk_action" class="form-control">
                            ...
                            <option value="delete" data-action="./admin/proposals/delete">Delete</option>
                        </select>
                        <span class="input-group-btn">
		...
		<thead>
			<tr>
                ...
                <th data-sortable="name">Proposal Name</th>
                <th data-sortable="email">Client</th>
                <th>Created</th>
			...
			<tr class="filter-row">
				<th></th>
                <th>
                    <input placeholder="Proposal Name" name="filter[proposal-contains]" value="<?php echo $state->get('filter.proposal-contains'); ?>" type="text" class="form-control input-sm">
                </th>
                <th>
        ...
        <?php if (!empty($paginated->items)) { ?>
            ...
            <?php foreach($paginated->items as $item) { ?>
                <tr>
                    ...
                    <td class="">
                        <a href="./admin/proposal/edit/<?php echo $item->id; ?>">
                            <?php echo $item->name; ?>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $item->{'client.company'}; ?>
                    </td>
                    <td class="">
                    ...
                    <td class="">
                        <a target="_blank" href="admin/proposal/generate/<?php echo $item->id; ?>">Generate PDF</a>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-xs btn-secondary" href="./admin/proposal/edit/<?php echo $item->id; ?>">
                            <i class="fa fa-pencil"></i>
                        </a>
	                    &nbsp;
	                    <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="./admin/proposal/delete/<?php echo $item->id; ?>">
