...
class Login extends \Users\Site\Controllers\Login
{
    ...
    public function auth()
    {
        ...
        if ($custom_redirect = \Dsc\System::instance()->get( 'session' )->get( 'dash.login.redirect' ))
        {
        ...
        try
        {
            ...
            $customers = new \Dash\Models\Customers;

            $customer = $customers->setCondition('_id', new \MongoId((string) $user->company))->getItem();
        ...
        \Dsc\System::instance()->get( 'session' )->set( 'dash.login.redirect', null );
