<a class="btn btn-success pull-right" href="./<?php echo $PARAMS['eventid']?>/prize/create">New Prize</a>
    ...
    <table class="table table-striped table-bordered table-hover table-highlight table-checkable">
        <thead>
            <tr>
                ...
                <th data-sortable="metadata.title">Name</th>
                <th>Win By</th>
                <th>Winner</th>
        ...
        <?php foreach ($list->items as $item) { ?>
            ...
            <tr>
                ...
                <td class="">
                    <a href="./<?php echo $PARAMS['eventid'] ?>/prize/edit/<?php echo $item->id; ?>">
                    <?php echo $item->{'name'}; ?>
                    </a>             
                </td>
                
                <td class="">
                    <?php echo $item->{'winbytime'}; ?>
                </td>
                
                <td class="">
                    <?php echo $item->{'winner.name'}; ?>
                </td>
                
            
                                
                <td class="text-center">
                    <a class="btn btn-s btn-success" href="./<?php echo $PARAMS['eventid'] ?>/prize/edit/<?php echo $item->id; ?>">
                        <i class="icon-edit"></i>
                    </a>
                    &nbsp;
