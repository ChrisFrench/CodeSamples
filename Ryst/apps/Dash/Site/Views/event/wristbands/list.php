<a class="btn btn-success pull-right" href="./<?php echo $PARAMS['eventid']?>/wristband/create">1 New wristband</a>
<a class="btn btn-success pull-right" href="./<?php echo $PARAMS['eventid']?>/wristbands/generate">Generate New wristbands</a>
        ...
        <?php foreach ($list->items as $item) { ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-s btn-success" href="./<?php echo $PARAMS['eventid'] ?>/wristband/edit/<?php echo $item->id; ?>">
                        <i class="icon-edit"></i>
                    </a>
                    &nbsp;
